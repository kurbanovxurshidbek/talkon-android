...
import com.talkon.uz.activity.entryActivity.NumberVerificationActivity
import com.talkon.uz.activity.entryActivity.LogInActivity
import com.talkon.uz.activity.entryActivity.StatusChooseActivity
...
open class BaseActivity : AppCompatActivity() {
    ...
    fun callNumberVerificationActivity(context: Context, phoneNumber: String) {
    ...
    fun callAboutTeacherActivity(context: Context) {
        val intent = Intent(this, com.talkon.uz.activity.AboutTeacherActivity::class.java)
        startActivity(intent)
        finish()
    }
